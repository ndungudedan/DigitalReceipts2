package com.example.dedan.digitalreceipts.Month_Database.March;

import androidx.room.ColumnInfo;
import androidx.room.Entity;
import androidx.room.PrimaryKey;

@Entity(tableName = "March")
public class MarEntity {
    ...
    public MarEntity(int KEY_SALES, int KEY_NO_OF_CLIENTS, String KEY_FOREIGN_KEY, String KEY_TYPE) {
