...
public class UserStatsAdapter extends ListAdapter<UserStatsEntity,UserStatsAdapter.userStatsHolder> {
    ...
    public void onBindViewHolder(@NonNull userStatsHolder holder, int position) {
        ...
        if(User_StatsFragment2.BUTTON_PRESSED=="MONTH"){
            holder.txtdate.setText(userStatsEntity.getKEY_MONTH());
            holder.txtsale.setText(String.valueOf(userStatsEntity.getKEY_MONTH_SALES()));
            holder.txtclient.setText(String.valueOf(userStatsEntity.getKEY_M_CLIENTS_SERVED()));
        }
        else if(User_StatsFragment2.BUTTON_PRESSED.equals("WEEK")){
    ...
    class userStatsHolder extends RecyclerView.ViewHolder {
        ...
        public userStatsHolder(@NonNull View itemView) {
            ...
            txtclient=itemView.findViewById(R.id.Mclient_served);
            txtsale=itemView.findViewById(R.id.Msales);
