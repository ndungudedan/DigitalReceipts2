...
public class homeGoodsAdapter extends ListAdapter<GoodsEntity,homeGoodsAdapter.UnitHolder> {
    ...
    public UnitHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView= LayoutInflater.from(parent.getContext())
                .inflate(R.layout.home_unit_recycler,parent,false); //home activity uses home_unit_recycler
        return new UnitHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull homeGoodsAdapter.UnitHolder holder, int position) {
