package com.example.dedan.digitalreceipts.Month_Database.February;
...
public class FebEntity {
    ...
    public FebEntity(int KEY_SALES, int KEY_NO_OF_CLIENTS, String KEY_FOREIGN_KEY, String KEY_TYPE) {
