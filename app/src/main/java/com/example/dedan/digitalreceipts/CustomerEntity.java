...
public class CustomerEntity {
    ...
    private int KEY_phone;
    @ColumnInfo(name="location")
    private String KEY_location;
    @ColumnInfo(name="address")
    private int KEY_address;
    @ColumnInfo(name="PO_BOX")
    private int KEY_po_box;
    @ColumnInfo(name="email")
    private String KEY_email;

    public CustomerEntity(String KEY_first_name, String KEY_sec_name, int KEY_phone, String KEY_location,
                          int KEY_address, int KEY_po_box, String KEY_email) {
    ...
    public int getKEY_phone() {
        return KEY_phone;
    }

    public void setKEY_phone(int KEY_phone) {
        this.KEY_phone = KEY_phone;
    }
    ...
    public int getKEY_address() {
        return KEY_address;
    }

    public void setKEY_address(int KEY_address) {
        this.KEY_address = KEY_address;
    }

    public int getKEY_po_box() {
        return KEY_po_box;
    }

    public void setKEY_po_box(int KEY_po_box) {
        this.KEY_po_box = KEY_po_box;
    }
